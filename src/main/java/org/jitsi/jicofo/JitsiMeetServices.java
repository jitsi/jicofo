...
public class JitsiMeetServices
{
    ...
    public void start()
    {
        ...
        {
            JigasiDetector jigasiDetector = new JigasiDetector(protocolProvider, JigasiConfig.config.getBrewery());
            logger.info("Using a Jigasi detector with MUC: " + JigasiConfig.config.getBrewery());
