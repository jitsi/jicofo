...
interface ChatRoom {
     ...
     */
    fun containsPresenceExtension(elementName: String, namespace: String): Boolean
     ...
     */
    fun modifyPresence(toRemove: Collection<ExtensionElement>, toAdd: Collection<ExtensionElement>)

    fun setPresenceExtension(extension: ExtensionElement, remove: Boolean)
