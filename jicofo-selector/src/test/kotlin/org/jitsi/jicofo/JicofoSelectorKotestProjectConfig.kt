...
/**
 * Note: jicofo and jicofo-selector still share packages, so the class name is change to avoid conflicts.
 */
class JicofoSelectorKotestProjectConfig : AbstractProjectConfig() {
