...
LD_LIBRARY_PATH=$libs exec java -Xmx$JICOFO_MAX_MEMORY -XX:-HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/tmp -Djava.library.path=$libs $LOGGING_CONFIG_PARAM $JAVA_SYS_PROPS -cp $cp $mainClass $@
